...
async function go() {
    let client = new MongoClient(`mongodb+srv://todoAppUser:rty@cluster0.xnavc.mongodb.net/ToDoApp?retryWrites=true&w=majority`)
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic cmFrZXNocm9ieTpxd2VydHlAMTIz") {
    next()
  } else {
